...
public class RegistrationServiceImpl implements RegistrationService {
	...
	private RegistrationDTO convertToDTO(Registration item,long total){
		...
		List<GroupInfo> groupInfoList = new ArrayList<>(item.getSubjectGroup().getGroupInfo());
		String sRooms = "";
		String sShifts = "";
		String sWeeks = "";
		for(GroupInfo groupInfo:groupInfoList) {
			...
			sWeeks+=sWeek;
			sRooms += groupInfo.getRoom().getName() + "-"
					+ groupInfo.getRoom().getBuilding().getName();
			sShifts += groupInfo.getShift().getName();
		...
		registrationDTO.setLearningDay(item.getSubjectGroup().getLearningDay());
		registrationDTO.setRoom(sRooms);
		registrationDTO.setShift(sShifts);
		registrationDTO.setLearningWeek(sWeeks);
