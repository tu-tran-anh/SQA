...
public class AssignedSubjectControllerTest3 {
    ...
    public void setUp(){
        Term term = new Term();
        term.setId(1);
        term.setStartDate(Date.valueOf("2022-03-07"));
        term.setEndDate(Date.valueOf("2022-09-06"));
        term.setStartRegTime(Timestamp.valueOf("2022-02-30 01:00:00"));
        term.setEndRegTime(Timestamp.valueOf("2022-03-30 12:00:00"));
    ...
    public void testFindByTeacher(){
        ...
        try {
            mockMvc.perform(requestBuilder)
                    ...
                    .andExpect(jsonPath("$",
                            containsString("Thời gian đăng kí tín bắt đầu từ 1:0:0 30/02/2022 đến 12:0:0 30/03/2022")));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
