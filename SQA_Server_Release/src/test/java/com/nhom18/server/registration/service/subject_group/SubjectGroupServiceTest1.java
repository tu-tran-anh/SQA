...
// test tìm kiếm danh sách các nhóm học theo thứ tự tăng dần mã nhóm của môn học có id là 1
    @Test
    public void testFindByTermSubject(){
        ...
        Assertions.assertEquals(2,ans.size()); // list size = 2 thì pass

        // Nhóm có mã nhóm nhỏ hơn xếp trước thì pass
